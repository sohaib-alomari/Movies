...
public class AllMoviesProvider extends ContentProvider {

    static final String PROVIDER_NAME = "tmdb.omari.com.tmdb.AllMovies";
    static final String URL = "content://" + PROVIDER_NAME + "/allmovies";
    ...
    static{
        ...
        uriMatcher.addURI(PROVIDER_NAME, "allmovies", MOVIES);
        uriMatcher.addURI(PROVIDER_NAME, "allmovies/#", MOVIES_ID);
    }
    ...
    static final String DATABASE_NAME = "AllMovies";
    public static  String MOVIES_TABLE_NAME = "AllMovies";
    ...
    public String getType(Uri uri) {
        switch (uriMatcher.match(uri)){
             ...
             */
            case MOVIES:
                return "vnd.android.cursor.dir/vnd.example.allmovies";

            /**
             * Get a particular student
             */
            case MOVIES_ID:
                return "vnd.android.cursor.item/vnd.example.allmovies";
