...
public class MProvider extends ContentProvider {
    ...
    static final String PROVIDER_NAME = "tmdb.omari.com.tmdb.Moviess";
    static final String URL = "content://" + PROVIDER_NAME + "/popmovies";
    ...
    static{
        ...
        uriMatcher.addURI(PROVIDER_NAME, "popmovies", MOVIES);
        uriMatcher.addURI(PROVIDER_NAME, "popmovies/#", MOVIES_ID);
    }
    ...
    static final String DATABASE_NAME = "Moviess";
    public static  String MOVIES_TABLE_NAME = "Moviess";
